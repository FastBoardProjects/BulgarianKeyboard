...
public class LatestVoiceHelper extends Activity {
    ...
    private LatestVoiceServiceBridge mLatestVoiceServiceBridge;

    @Override
    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);

        mLatestVoiceServiceBridge = new LatestVoiceServiceBridge();
    ...
    private void notifyResult(String result) {
        mLatestVoiceServiceBridge.notifyResult(this, result);
        finish();
    }
}
