...
class LatestVoiceApiVoiceTrigger implements LatestVoiceTrigger {

    private static final String TAG = "VoiceIntentApiTrigger";

    private final InputMethodService mInputMethodService;

    private final LatestVoiceServiceBridge mLatestVoiceServiceBridge;

    private String mLastRecognitionResult;

    private final Set<Character> mUpperCaseChars;

    private final Handler mHandler;

    private IBinder mToken;

    public LatestVoiceApiVoiceTrigger(InputMethodService inputMethodService) {
        mInputMethodService = inputMethodService;

        mLatestVoiceServiceBridge =
                new LatestVoiceServiceBridge(
                        new Callback() {
    ...
    public void startVoiceRecognition(String language) {
        ...
        mLatestVoiceServiceBridge.startVoiceRecognition(mInputMethodService, language);
    }
